	...
	<view class="a_container">
		<uni-forms class="a_query_form" :model="pageData.detailData" ref="detailFormRef"
			...
			<uni-forms-item class="a_query_form_item" label="值类型：" name="valueType">
				<text class="a_detail_text">{{pageData.detailData.valueTypeExtend}}</text>
			</uni-forms-item>
			...
			<uni-forms-item class="a_query_form_item" label="报警开关：" name="alarmSwitch">
				<text class="a_detail_text">{{pageData.detailData.alarmSwitchExtend}}</text>
			</uni-forms-item>
...
<style lang="scss">
//@import '@/static/styles/autoee/iotAlarmRule/iotAlarmRuleDetail.scss';
</style>
