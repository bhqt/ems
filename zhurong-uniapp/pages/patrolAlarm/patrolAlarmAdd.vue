<template>
	<view class="a_container">
		<uni-forms class="a_add_form" :model="pageData.addUpdateForm" ref="addUpdateFormRef" :rules="pageData.addUpdateFormRules"
			...
			<uni-forms-item v-show="true" class="a_add_form_item" label="报警编号" name="alarmNo">
				<uni-easyinput v-model="pageData.addUpdateForm.alarmNo" placeholder="请输入报警编号" clearable/>
			</uni-forms-item>
			...
			<uni-forms-item v-show="true" class="a_add_form_item" label="报警类型" name="patrolAlarmType">
				<uni-data-picker class="a_add_form_select" v-model="pageData.addUpdateForm.patrolAlarmType" :localdata="pageData.dictData.patrol_alarm_type" placeholder="请选择" clearable>
				</uni-data-picker>
			</uni-forms-item>
			<uni-forms-item v-show="true" class="a_add_form_item" label="报警时间" name="patrolAlarmTime">
				<uni-datetime-picker v-model="pageData.addUpdateForm.patrolAlarmTime" type="datetime" return-type="string" placeholder="请选择" clearable/>
			</uni-forms-item>
			<uni-forms-item v-show="true" class="a_add_form_item" label="报警内容" name="patrolAlarmContent">
				<uni-easyinput type="textarea" v-model="pageData.addUpdateForm.patrolAlarmContent" placeholder="请输入报警内容" clearable/>
			</uni-forms-item>
			<uni-forms-item v-show="true" class="a_add_form_item" label="报警状态" name="patrolAlarmStatus">
				<uni-data-picker class="a_add_form_select" v-model="pageData.addUpdateForm.patrolAlarmStatus" :localdata="pageData.dictData.patrol_alarm_status" placeholder="请选择" clearable>
				</uni-data-picker>
			</uni-forms-item>
