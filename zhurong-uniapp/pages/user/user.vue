		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="imageUrl" mode="aspectFill"> </image>
				</view>
				<view class="info-box">
			...
			<view class="history-section icon">
				...
				<scroll-view scroll-x class="h-list"> -->
					...
					<image @click="navTo('/pages/product/product')"
						...
						mode="aspectFill"></image> -->
				<!-- </scroll-view> -->
				<list-cell icon="icon-zuanshi" iconColor="#5fcda2" title="个人资料"
					@eventClick="navTo('/pages/userinfo/updateUserInfo')"></list-cell>
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			this.baseInfo = this.user.baseInfo
