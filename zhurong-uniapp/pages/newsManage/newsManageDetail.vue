	...
	<view class="a_container">
		<uni-forms class="a_query_form" :model="pageData.detailData" ref="detailFormRef"
			...
			<uni-forms-item class="a_query_form_item" label="新闻版块：" name="newsModule">
				<text class="a_detail_text">{{pageData.detailData.newsModuleExtend}}</text>
			</uni-forms-item>
			<uni-forms-item class="a_query_form_item" label="新闻类型：" name="newsType">
				<text class="a_detail_text">{{pageData.detailData.newsTypeExtend}}</text>
			</uni-forms-item>
			<uni-forms-item class="a_query_form_item" label="作者：" name="author">
				<text class="a_detail_text">{{pageData.detailData.author}}</text>
			</uni-forms-item>
			<uni-forms-item class="a_query_form_item" label="新闻状态：" name="newsStatus">
...
<style lang="scss">
//@import '@/static/styles/autoee/newsManage/newsManageDetail.scss';
</style>
