	...
	<view class="a_container">
		<uni-forms class="a_query_form" :model="pageData.detailData" ref="detailFormRef"
			...
			<uni-forms-item class="a_query_form_item" label="入库编号：" name="dangerGoodsStockInId">
				<text class="a_detail_text">{{pageData.detailData.dangerGoodsStockInIdExtend}}</text>
			</uni-forms-item>
...
<style lang="scss">
//@import '@/static/styles/autoee/dangerGoodsStockOut/dangerGoodsStockOutDetail.scss';
</style>
