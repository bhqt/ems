	...
	<view class="a_container">
		<uni-forms class="a_query_form" :model="pageData.detailData" ref="detailFormRef"
			...
			<uni-forms-item class="a_query_form_item" label="物品名称：" name="goodsName">
				<text class="a_detail_text">{{pageData.detailData.goodsName ? pageData.detailData.goodsName : '' }}</text>
			</uni-forms-item>
			<uni-forms-item class="a_query_form_item" label="物品类型：" name="goodsType">
				<text class="a_detail_text">{{pageData.detailData.goodsTypeExtend}}</text>
			</uni-forms-item>
			<uni-forms-item class="a_query_form_item" label="物品状态：" name="goodsStatus">
				<text class="a_detail_text">{{pageData.detailData.goodsStatusExtend}}</text>
			</uni-forms-item>
...
<style lang="scss">
//@import '@/static/styles/autoee/goodsInfo/goodsInfoDetail.scss';
</style>
