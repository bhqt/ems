...
import com.ruoyi.system.service.IAttachmentInfoService;
...
public class AttachmentInfoController extends BaseController {
     ...
     * 导出备件库管理列表
     */
    @SaCheckPermission("system:attachment:export")
     ...
     */
    @SaCheckPermission("system:attachment:query")
     ...
     * 新增备件库管理
     */
    @SaCheckPermission("system:attachment:add")
     ...
     * 修改备件库管理
     */
    @SaCheckPermission("system:attachment:edit")
     ...
     */
    @SaCheckPermission("system:attachment:remove")
