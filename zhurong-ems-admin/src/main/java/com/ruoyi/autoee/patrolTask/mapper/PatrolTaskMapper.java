package com.ruoyi.autoee.patrolTask.mapper;
 ...
 *
 */
public interface PatrolTaskMapper extends BaseMapperPlus<PatrolTaskMapper, PatrolTask, PatrolTask>
{
    /**
     * 查询巡更任务
     *
