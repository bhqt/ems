package com.ruoyi.autoee.patrolRecord.mapper;
 ...
 *
 */
public interface PatrolRecordMapper extends BaseMapperPlus<PatrolRecordMapper, PatrolRecord, PatrolRecord>
{
    /**
     * 查询巡更记录
     *
