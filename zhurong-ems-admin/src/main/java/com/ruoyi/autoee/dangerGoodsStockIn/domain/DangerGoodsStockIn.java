package com.ruoyi.autoee.dangerGoodsStockIn.domain;
...
/**
 * 危化品入库记录对象 a_danger_goods_stock_in
 *
 * @author AutoEE亿达科技有限公司 版权所有 Spring全栈工程师
 *
 */
// 设置实体类对应的表名
@TableName("a_danger_goods_stock_in") // 如果使用了 MyBatis-Plus，表名默认是根据实体类名自动转换的，如果你的实体类名为 PatrolRecord，MyBatis-Plus 默认会将其转换为 patrol_record表名，而不是你期望的 a_patrol_record。
public class DangerGoodsStockIn extends BaseEntity
{
