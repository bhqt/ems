...
import com.ruoyi.system.domain.bo.AlarmRuleBo;
import com.ruoyi.system.domain.vo.AlarmRuleVo;
import com.ruoyi.system.mapper.AlarmRuleMapper;
import com.ruoyi.system.service.IAlarmRuleService;
...
public class AlarmRuleServiceImpl implements IAlarmRuleService {
    ...
    public TableDataInfo<AlarmRuleVo> queryPageList(AlarmRuleBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(AlarmRule::getUpdateTime);
