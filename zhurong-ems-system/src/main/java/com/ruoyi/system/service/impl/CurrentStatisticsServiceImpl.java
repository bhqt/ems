...
import com.ruoyi.system.domain.CurrentStatistics;
import com.ruoyi.system.domain.bo.CurrentStatisticsBo;
import com.ruoyi.system.domain.vo.CurrentStatisticsVo;
import com.ruoyi.system.mapper.CurrentStatisticsMapper;
import com.ruoyi.system.service.ICurrentStatisticsService;
...
public class CurrentStatisticsServiceImpl implements ICurrentStatisticsService {
    ...
    public TableDataInfo<CurrentStatisticsVo> queryPageList(CurrentStatisticsBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(CurrentStatistics::getUpdateTime);
