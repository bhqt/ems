...
import com.ruoyi.system.domain.PrePlan;
import com.ruoyi.system.domain.bo.PrePlanBo;
import com.ruoyi.system.domain.vo.PrePlanVo;
import com.ruoyi.system.mapper.PrePlanMapper;
import com.ruoyi.system.service.IPrePlanService;
...
public class PrePlanServiceImpl implements IPrePlanService {
    ...
    public TableDataInfo<PrePlanVo> queryPageList(PrePlanBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(PrePlan::getUpdateTime);
