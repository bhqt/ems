...
import com.ruoyi.system.domain.OccupancyOrder;
import com.ruoyi.system.domain.OrderInfo;
import com.ruoyi.system.domain.bo.OccupancyOrderBo;
import com.ruoyi.system.domain.vo.OccupancyOrderVo;
import com.ruoyi.system.domain.vo.OrderInfoVo;
import com.ruoyi.system.mapper.OccupancyOrderMapper;
import com.ruoyi.system.mapper.OrderInfoMapper;
import com.ruoyi.system.service.IOccupancyOrderService;
...
public class OccupancyOrderServiceImpl implements IOccupancyOrderService {
    ...
    public TableDataInfo<OccupancyOrderVo> queryPageList(OccupancyOrderBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(OccupancyOrder::getUpdateTime);
