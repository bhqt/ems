...
import com.ruoyi.system.domain.enums.InspectionRecordStatus;
import com.ruoyi.system.domain.enums.RepairOrderStatus;
import com.ruoyi.system.domain.vo.InspectionRecordVo;
import com.ruoyi.system.domain.vo.RepairOrderVo;
import com.ruoyi.system.domain.vo.StateCountVo;
...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public int updateUserSimpleInfo(SysUser user) {
        Long userId = user.getUserId();
        return baseMapper.updateById(user);
    }
}
