...
import com.ruoyi.system.domain.Duty;
import com.ruoyi.system.domain.bo.DutyBo;
import com.ruoyi.system.domain.vo.DutyVo;
import com.ruoyi.system.mapper.DutyMapper;
import com.ruoyi.system.service.IDutyService;
...
public class DutyServiceImpl implements IDutyService {
    ...
    public TableDataInfo<DutyVo> queryPageList(DutyBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(Duty::getUpdateTime);
