...
import com.ruoyi.system.domain.EnergyStatistics;
import com.ruoyi.system.domain.bo.ItemTopologyBo;
import com.ruoyi.system.domain.vo.ItemTopologyVo;
import com.ruoyi.system.mapper.EnergyMapper;
import com.ruoyi.system.mapper.EnergyStatisticsMapper;
import com.ruoyi.system.mapper.EquipmentInfoMapper;
import com.ruoyi.system.service.IItemTopologyService;
import com.ruoyi.system.domain.ElectricityW;
...
public class ElectricityWServiceImpl implements IElectricityWService {
    ...
    public ElectricityWVo queryById(Long id) {
        return electricityWMapper.selectVoById(id);
    }
    ...
    public TableDataInfo<ElectricityWVo> queryPageList(ElectricityWBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(ElectricityW::getId);
        Page<ElectricityWVo> result = electricityWMapper.selectVoPage(pageQuery.build(), lqw);
    ...
    public List<ElectricityWVo> queryList(ElectricityWBo bo) {
        LambdaQueryWrapper<ElectricityW> lqw = buildQueryWrapper(bo);
        lqw.orderByDesc(ElectricityW::getId);
        return electricityWMapper.selectVoList(lqw);
    }
    ...
    public Boolean insertByBo(ElectricityWBo bo) {
        ...
        boolean flag = electricityWMapper.insert(add) > 0;
        if (flag) {
            bo.setId(add.getId());
        }
        return flag;
    ...
    public Boolean updateByBo(ElectricityWBo bo) {
        ...
        return electricityWMapper.updateById(update) > 0;
    }
    ...
    public Boolean deleteWithValidByIds(Collection<Long> ids, Boolean isValid) {
        ...
        return electricityWMapper.deleteBatchIds(ids) > 0;
    }
    ...
    public ElectricityWVo getByDay(String date) {
        ...
        List<ElectricityWVo> electricityWS = electricityWMapper.selectVoList(new LambdaQueryWrapper<ElectricityW>()
    ...
    public Map<String, BigDecimal> getChain() {
        ...
        List<ElectricityWVo> now = electricityWMapper.selectVoList(new LambdaQueryWrapper<ElectricityW>()
            .ge(ElectricityW::getCreateTime, nowTime).orderByDesc(ElectricityW::getCreateTime));
        List<ElectricityWVo> last = electricityWMapper.selectVoList(new LambdaQueryWrapper<ElectricityW>()
        ...
        List<ElectricityWVo> nowData = electricityWMapper.selectVoList(new LambdaQueryWrapper<ElectricityW>()
            .ge(ElectricityW::getCreateTime, nowDate).orderByDesc(ElectricityW::getCreateTime));
        List<ElectricityWVo> lastData = electricityWMapper.selectVoList(new LambdaQueryWrapper<ElectricityW>()
        ...
        List<ElectricityWVo> yearData = electricityWMapper.selectVoList(new LambdaQueryWrapper<ElectricityW>()
            .ge(ElectricityW::getCreateTime, year).orderByDesc(ElectricityW::getCreateTime));
        List<ElectricityWVo> lastYearData = electricityWMapper.selectVoList(new LambdaQueryWrapper<ElectricityW>()
