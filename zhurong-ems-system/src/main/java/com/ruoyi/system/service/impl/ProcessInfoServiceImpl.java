...
import com.ruoyi.system.domain.ProcessInfo;
import com.ruoyi.system.domain.bo.ProcessInfoBo;
import com.ruoyi.system.domain.vo.ProcessInfoVo;
import com.ruoyi.system.mapper.ProcessInfoMapper;
import com.ruoyi.system.service.IProcessInfoService;
...
public class ProcessInfoServiceImpl implements IProcessInfoService {
    ...
    public TableDataInfo<ProcessInfoVo> queryPageList(ProcessInfoBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(ProcessInfo::getUpdateTime);
