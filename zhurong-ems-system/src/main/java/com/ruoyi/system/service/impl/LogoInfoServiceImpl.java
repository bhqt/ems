...
import com.ruoyi.system.domain.LogoInfo;
import com.ruoyi.system.domain.SysOss;
import com.ruoyi.system.domain.bo.LogoInfoBo;
import com.ruoyi.system.domain.vo.LogoInfoVo;
import com.ruoyi.system.mapper.LogoInfoMapper;
import com.ruoyi.system.mapper.SysOssMapper;
import com.ruoyi.system.service.ILogoInfoService;
...
public class LogoInfoServiceImpl implements ILogoInfoService {
    ...
    public TableDataInfo<LogoInfoVo> queryPageList(LogoInfoBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(LogoInfo::getUpdateTime);
        ...
        if (ids.size() > 0) {
            List<SysOss> ossList = sysOssMapper.selectBatchIds(ids);
