...
import com.ruoyi.system.domain.enums.AlarmLevelType;
...
import com.ruoyi.system.domain.RealtimeAlarm;
...
public class RealtimeAlarmServiceImpl implements IRealtimeAlarmService {
    ...
    public TableDataInfo<RealtimeAlarmVo> queryPageList(RealtimeAlarmBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(RealtimeAlarm::getUpdateTime);

        // 按更新时间和id倒序排序
        lqw.orderByDesc(RealtimeAlarm::getUpdateTime).orderByDesc(RealtimeAlarm::getId);
