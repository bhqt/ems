...
import com.ruoyi.system.domain.ChargingPriceParam;
import com.ruoyi.system.domain.bo.ChargingPriceParamBo;
import com.ruoyi.system.domain.vo.ChargingPriceParamVo;
import com.ruoyi.system.mapper.ChargingPriceParamMapper;
import com.ruoyi.system.service.IChargingPriceParamService;
...
public class ChargingPriceParamServiceImpl implements IChargingPriceParamService {
    ...
    public TableDataInfo<ChargingPriceParamVo> queryPageList(ChargingPriceParamBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(ChargingPriceParam::getUpdateTime);
