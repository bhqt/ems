...
public class SysConfigServiceImpl implements ISysConfigService, ConfigService {
    ...
    public Map<String, Object> logoInfo() {
        ...
        result.put("loginLogo", Boolean.parseBoolean(selectConfigByKey("sys.login.logo.show")));
        result.put("experienceShow", Boolean.parseBoolean(selectConfigByKey("sys.account.experience")));
        result.put("theme", selectConfigByKey("sys.index.theme"));
        return result;
    }
