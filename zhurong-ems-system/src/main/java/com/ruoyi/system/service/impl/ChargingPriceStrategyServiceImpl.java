...
import com.ruoyi.system.domain.ChargingPriceStrategy;
import com.ruoyi.system.domain.bo.ChargingPriceStrategyBo;
import com.ruoyi.system.domain.vo.ChargingPriceStrategyVo;
import com.ruoyi.system.mapper.ChargingPriceStrategyMapper;
import com.ruoyi.system.service.IChargingPriceStrategyService;
...
public class ChargingPriceStrategyServiceImpl implements IChargingPriceStrategyService {
    ...
    public TableDataInfo<ChargingPriceStrategyVo> queryPageList(ChargingPriceStrategyBo bo, PageQuery pageQuery) {
        ...
        lqw.orderByDesc(ChargingPriceStrategy::getUpdateTime);
