...
public interface ISysUserService {
     ...
     * @return
     */
    TableDataInfo<SysUser> selectPageInspector(SysUser user, PageQuery pageQuery);

    /**
     * 统计登录用户的工单、巡检数量
     */
    Map<String, Object> countRepairAndInspection();

    int updateUserSimpleInfo(SysUser user);
}
