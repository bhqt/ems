...
export default {
  ...
  dispatchModule: {
    ...
    scheme: {
      ...
      constraintsText: '约束条件',
      resultText: '优化结果',
      status: '方案状态',
      costMinimization: '成本最小化',
      emissionMinimization: '排放最小化',
      ...
      detail: '方案详情',
      placeholder: {
        inputSchemeCode: '请输入方案编号',
        inputSchemeName: '请输入方案名称',
        selectOptimizationType: '请选择优化类型',
  ...
  contractInfoModule: {
    title: '合同管理',
    contractNoNew: '合同编号(新)',
    contractNoOld: '续签编号(老)',
    belongCustomer: '所属客户',
    customerContact: '客户方联系人',
    contractType: '合同类型',
    contractSubtype: '合同子类型',
    signCompany: '签约公司',
    salesmanId: '业务员',
    techSupport: '技术支持',
    quoteNo: '报价单号',
    ...
    updateTime: '更新时间',
    placeholder: {
      inputContractNoNew: '请输入合同编号(新)',
      inputContractNoOld: '请输入续签编号(老)',
      inputBelongCustomer: '请输入所属客户',
      inputCustomerContact: '请输入客户方联系人',
      inputSalesmanId: '请输入业务员',
      selectContractType: '请选择合同类型',
      selectContractSubtype: '请选择合同子类型'
    }
  },
  alarmModule: {
    title: '报警管理',
  ...
  quotaModule: {
    ...
    overLimitRange: '越限范围',
    energyArea: '能源区域',
    energySubsections: '能源分项',
    startDate: '开始日期',
    endDate: '结束日期',
    placeholder: {
      selectQuotaType: '请选择定额类型',
      inputQuotaValue: '填写定额数值,如10000,20000等',
      inputCriticalRange: '填写临界范围比例,如0.8、0.9等',
      inputOverLimitRange: '填写越限范围比例,如1.1、1.2等'
    }
  },
  systemModule: {
    title: '系统管理',
  ...
  digitaltwinModule: {
    ...
    energyFlow: '能源流向',
    threeDArea: '3D区域',
    tip: '提示: 3D模型资源待配置，当前显示2D模拟视图',
    energyFlowMonitor: '能源流向监控',
    energyType: '能源类型',
    input: '输入',
    output: '输出',
    loss: '损耗',
    efficiency: '效率(%)',
    twinDeviceStatus: '孪生设备状态',
    deviceName: '设备名称',
    deviceType: '设备类型',
    location: '位置'
  },
  inventoryModule: {
    ...
    purveyor: {
      ...
      address: '供应商地址',
      placeholder: {
        inputPurveyorCode: '请输入供应商编号',
        inputPurveyorName: '请输入供应商名称',
        selectNature: '请选择供应商性质',
        selectSupplyType: '请选择供货类型'
      }
    }
  },
  managementSystemModule: {
    ...
    standardCode: '规范编码',
    standardName: '规范名称',
    standardDescribe: '规范描述',
    regulationCode: '制度编码',
    regulationName: '制度名称',
    regulationDescribe: '制度描述',
    regulationType: '制度类型',
    uploadTime: '上传时间',
    prePlanNumber: '预案编号',
    prePlanType: '预案类型',
  ...
  newenergyModule: {
    ...
    storageBattery: {
      ...
      ratedVoltage: '额定电压(V)',
      totalCapacity: '总容量(kWh)',
      seriesCount: '串数',
      parallelCount: '并数',
      status: '电池状态',
      commissioningDate: '投运日期',
      placeholder: {
        inputBatteryName: '请输入电池组名称',
        inputBatteryCode: '请输入电池组编号',
        selectStorageSystem: '请选择储能系统',
        selectStatus: '请选择电池状态',
        inputBatteryModel: '请输入电池型号'
      }
    }
  },
  reportModule: {
  ...
  repairModule: {
    ...
    addOrder: '添加工单',
    editOrder: '编辑工单',
    orderNoRequired: '工单编号不能为空',
    equipmentNameRequired: '设备名称不能为空',
    faultDescRequired: '故障描述不能为空'
  },
  goodsModule: {
    title: '物资管理',
    goodsInfo: '物资信息管理',
    goodsInventory: '物资库存管理',
    goodsStockIn: '物资入库管理',
    goodsStockOut: '物资出库管理',
    goodsName: '物资名称',
    goodsCode: '物资编码',
    goodsCategory: '物资分类',
    goodsUnit: '计量单位',
    ...
    stockIn: '入库',
    stockOut: '出库',
    goodsNameRequired: '物资名称不能为空',
    goodsCodeRequired: '物资编码不能为空',
    goodsUnitRequired: '计量单位不能为空'
  },
  dangerGoodsModule: {
    title: '危险品管理',
    dangerGoodsInfo: '危险品信息管理',
    dangerGoodsInventory: '危险品库存管理',
    dangerGoodsStockIn: '危险品入库管理',
    dangerGoodsStockOut: '危险品出库管理',
    dangerGoodsName: '危化品名称',
    dangerGoodsStatus: '危化品状态',
    dangerType: '危险品类型',
    specification: '规格型号',
    storageLocation: '存储位置',
    currentStock: '当前库存数量',
    dangerStockInNo: '入库编号',
    dangerStockInQty: '入库数量',
    dangerStockOutNo: '出库编号',
    dangerStockOutQty: '出库数量',
    dangerStockOutReason: '出库原因',
    dangerLevel: '危险等级',
    safetyDesc: '安全说明',
    storageRequirement: '存储要求',
    addDangerGoods: '添加危险品',
    editDangerGoods: '编辑危险品',
    dangerGoodsNameRequired: '危化品名称不能为空',
    dangerLevelRequired: '危险等级不能为空'
  },
  gatewayModule: {
    title: '网关管理',
    gatewayName: '网关名称',
    ...
    addGateway: '添加网关',
    editGateway: '编辑网关',
    gatewayNameRequired: '网关名称不能为空',
    gatewayCodeRequired: '网关编码不能为空'
  },
  hospital: {
    homeTitle: '医院智慧能源决策系统',
    homeDesc: '通过 IOT 平台回调接入医院检查检验设备运行与能耗数据，提供设备台账、指标定义与数据监控能力，为能耗分析与能源决策提供支撑。',
    deviceManage: '设备台账',
    deviceManageDesc: '管理 CT/MRI/DR/超声/检验流水线/DSA 等检查检验设备档案，支持 IOT 设备绑定',
    metricManage: '指标定义',
    metricManageDesc: '定义设备指标编码、名称、单位与数据类型，规范回调数据解析',
    callbackLogManage: '回调日志',
    callbackLogDesc: '查看 IOT 平台回调记录、处理状态与失败原因，保障数据接入可靠',
    deviceName: '设备名称',
    deviceCode: '设备编号',
    deviceType: '设备类型',
    model: '设备型号',
    manufacturer: '生产厂商',
    iotDeviceId: 'IOT设备ID',
    iotDeviceIdPlaceholder: '请输入 IOT 平台设备 ID（留空解绑）',
    unbound: '未绑定',
    bindIot: 'IOT绑定',
    viewData: '数据点',
    statusNormal: '正常',
    ...
    callbackStatus: '处理状态',
    callbackSuccess: '成功',
    callbackAuthFail: '鉴权失败',
    callbackParseFail: '解析失败',
    callbackFail: '失败',
    errorMsg: '错误信息',
    costTime: '耗时',
    receiveTime: '接收时间',
    ...
    qualityBad: '异常',
    monitorManage: '设备监测',
    monitorManageDesc: '实时展示检查检验设备在线状态、运行状态与能耗数据',
    onlineStatus: '在线状态',
    online: '在线',
    offline: '离线',
    noData: '无数据',
    ...
    standby: '待机',
    lastPower: '实时功率(kW)',
    lastElectricity: '累计电量(kWh)',
    lastUpdate: '最近数据时间',
    openAlarm: '未处理报警',
    viewTrend: '趋势',
    trendData: '趋势数据',
    autoRefresh: '自动刷新',
    alarmRuleManage: '报警规则',
    alarmRuleManageDesc: '配置设备过载、离线等报警规则与通知',
    ruleName: '规则名称',
    ruleType: '规则类型',
    thresholdRule: '阈值报警',
    offlineRule: '离线报警',
    ...
    disabled: '停用',
    notifyEmail: '通知邮箱',
    notifyEmailPlaceholder: '多个邮箱逗号分隔，留空仅记录不通知',
    addRule: '添加规则',
    editRule: '编辑规则',
    allDevices: '全部设备',
    ruleNameRequired: '规则名称不能为空',
    ruleTypeRequired: '规则类型不能为空',
    alarmRecordManage: '报警记录',
    alarmRecordManageDesc: '查看设备报警记录，处理与闭环',
    alarmType: '报警类型',
    overload: '过载',
    offlineAlarm: '离线',
    handleStatus: '处理状态',
    ...
    handleBy: '处理人',
    energyManage: '能耗分析',
    energyManageDesc: '全院能耗概览、趋势、排名与同比环比分析',
    efficiencyManage: '能效评估',
    efficiencyManageDesc: '设备能效评估、节能建议与分析报告导出',
    timeRange: '时间范围',
    drillLevel: '钻取层级',
    levelArea: '按院区',
    levelDept: '按科室',
    ...
    energyRank: '设备耗电排名',
    rankNo: '排名',
    efficiencyTitle: '设备能效评估',
    standbyRatio: '待机占比(%)',
    effScore: '能效评分',
    effLevel: '能效等级',
    suggestionTitle: '节能建议清单',
    noSuggestion: '当前周期暂无节能建议',
    exportEfficiency: '导出能效评估',
    exportSuggestions: '导出节能建议',
    areaManage: '院区管理',
    areaManageDesc: '多院区数据隔离与授权',
    areaName: '院区名称',
    areaCode: '院区编码',
    areaType: '院区类型',
    areaTypeCampus: '院区',
    areaTypeBuilding: '楼宇',
    areaNameRequired: '请输入院区名称',
    areaCodeRequired: '请输入院区编码',
    addArea: '新增院区',
    editArea: '修改院区',
    workloadManage: '工作量管理',
    workloadManageDesc: '设备工作量登记与单位能耗',
    workloadCount: '工作量',
    workloadDate: '统计日期',
    addWorkload: '新增工作量',
    editWorkload: '修改工作量',
    deviceRequired: '请选择设备',
    workloadDateRequired: '请选择统计日期',
    unitEnergy: '单位工作量能耗',
    screenManage: '医院大屏',
    screenManageDesc: '能源可视化看板',
    screenTitle: '医院智慧能源大屏',
    recentAlarm: '最近报警',
    escalated: '已升级',
    energyCategory: '分项能耗',
    energyCategoryTrend: '分项趋势',
    percent: '占比',
    hsNone: '待处理',
    hsConfirmed: '已确认',
    hsProcessing: '处理中',
