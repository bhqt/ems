  ...
  <el-drawer size="280px" :visible="visible" :with-header="false" :append-to-body="true" :show-close="false">
    <div class="drawer-container">
      <div>
        ...
        <div class="drawer-item">
          <div style="margin-bottom:12px;">{{ $t('settings.platformName') }}</div>
          <el-input :placeholder="$t('settings.platformNamePlaceholder')"></el-input>
        </div>

        <div class="drawer-item">
          <div style="margin-bottom:12px;">{{ $t('settings.platformLogo') }}</div>
          <el-input :placeholder="$t('settings.platformLogoPlaceholder')"></el-input>
        </div>
