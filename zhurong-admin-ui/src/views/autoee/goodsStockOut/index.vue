<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col v-if="false" :span="1.5">
        <el-button
          ...
          @click="handleUpdate"
          v-hasPermi="['autoee:goodsStockOut:edit']"
        >编辑</el-button>
      </el-col>
      <el-col v-if="false" :span="1.5">
        <el-button
      ...
      <el-col v-if="false" :span="1.5">
        <el-button
          ...
          v-hasPermi="['autoee:goodsStockOut:remove']"
        >删除</el-button>
      </el-col>
      <el-col v-if="false" :span="1.5">
        <el-button
      ...
      <el-col v-if="false" :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleImport"
          v-hasPermi="['autoee:goodsStockOut:import']"
        >导入</el-button>
      </el-col>
      <el-col v-if="true" :span="1.5">
        <el-button
    ...
    >
      ...
      <el-table-column v-if="true" label="入库编号" align="center" prop="goodsStockInId" sortable="custom" :sort-orders="['descending', 'ascending']">
