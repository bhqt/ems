...
export default {
    ...
    return {
      pageData: {
        ...
        importData: {
          ...
          url: process.env.VUE_APP_BASE_API + "/autoee/contractInfo/importContractInfoData",
          actionUrlExtend: "",
          fileSelected: false
        }
      }
  ...
  methods: {
    /** 导入按钮操作 */
    openContractInfoImportDialog(parentQueryParams) {

      if (contractInfoExtend.openImportDialogExtend(this, parentQueryParams)) {
    ...
    importTemplate() {
      ...
      this.download('autoee/contractInfo/downLoadImportTemplateContractInfo', {},
        `合同信息管理_导入模版_${fileExt}.xlsx`)
    },
  ...
  mounted() {
    // mounted扩展方法
    contractInfoExtend.importMountedStartExtend(this);
  }
};
</script>
