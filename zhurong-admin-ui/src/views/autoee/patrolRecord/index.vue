<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item class="a_query_form_item" :label="$t('patrolModule.pathName')" prop="patrolPathId">
        <el-select
          class="a_query_form_select"
      ...
      <el-form-item class="a_query_form_item" :label="$t('patrolModule.recordResult')" prop="patrolResult">
        <el-select
          class="a_query_form_select"
    ...
    >
      ...
      <el-table-column v-if="true" :label="$t('patrolModule.patrolPoint')" align="center" prop="patrolPointId" sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
      ...
      <el-table-column v-if="true" :label="$t('patrolModule.pointOrder')" align="center" prop="pointOrder" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column v-if="true" :label="$t('patrolModule.recordTime')" align="center" prop="arriveTime" sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
          <span>{{ $common.formatDateTime(scope.row.arriveTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column v-if="false" :label="$t('patrolModule.recordResult')" align="center" prop="patrolResult" sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.patrol_result" :value="scope.row.patrolResult"/>
        </template>
      </el-table-column>
      <el-table-column v-if="false" :label="$t('patrolModule.recordDesc')" align="center" prop="resultDesc" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']"/>
