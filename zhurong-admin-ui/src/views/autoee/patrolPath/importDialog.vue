...
export default {
    ...
    return {
      pageData: {
        ...
        importData: {
          ...
          url: process.env.VUE_APP_BASE_API + "/autoee/patrolPath/importPatrolPathData",
          actionUrlExtend: "",
          fileSelected: false
        }
      }
  ...
  methods: {
    /** 导入按钮操作 */
    openPatrolPathImportDialog(parentQueryParams) {

      if (patrolPathExtend.openImportDialogExtend(this, parentQueryParams)) {
    ...
    importTemplate() {
      ...
      this.download('autoee/patrolPath/downLoadImportTemplatePatrolPath', {},
        `巡更路线_导入模版_${fileExt}.xlsx`)
    },
  ...
  mounted() {
    // mounted扩展方法
    patrolPathExtend.importMountedStartExtend(this);
  }
};
</script>
