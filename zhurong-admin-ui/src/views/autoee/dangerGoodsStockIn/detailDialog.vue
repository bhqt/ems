<template>
  <div class="app-container">
    <!--查看危化品入库记录详细对话框 去掉高度设置  style="height: 800px"-->
...
export default {
  ...
  methods: {
    /** 打开详细窗口 */
    openDangerGoodsStockInDetailDialog(row) {
      dangerGoodsStockIn.selectDetailByPkDangerGoodsStockIn(row.id).then(response => {
        this.pageData.detailForm = response.data;
        this.pageData.open = true;
        this.pageData.title = "查看危化品入库记录";
      });
    },
