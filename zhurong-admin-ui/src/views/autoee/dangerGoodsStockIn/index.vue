<template>
  <div class="app-container">
    ...
    >
      <!-- 循环生成查询表单项 -->
      <el-form-item class="a_query_form_item" :label="$t('dangerGoodsModule.dangerStockInNo')" prop="id">
        <el-input
          clearable
          :placeholder="$t('dangerGoodsModule.dangerStockInNo')"
      ...
      <el-form-item class="a_query_form_item" :label="$t('dangerGoodsModule.storageLocation')" prop="supplier">
        <el-input
          clearable
          :placeholder="$t('dangerGoodsModule.storageLocation')"
    ...
    >
      ...
      <el-table-column :label="$t('dangerGoodsModule.dangerStockInNo')" align="center" prop="id" />
      ...
      <el-table-column v-if="true" :label="$t('dangerGoodsModule.dangerStockInQty')" align="center" prop="quantity" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column v-if="true" :label="$t('dangerGoodsModule.storageLocation')" align="center" prop="supplier" sortable="custom" :sort-orders="['descending', 'ascending']"/>
