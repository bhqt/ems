...
export default {
    ...
    return {
      pageData: {
        ...
        importData: {
          ...
          url: process.env.VUE_APP_BASE_API + "/autoee/dangerGoodsInventory/importDangerGoodsInventoryData",
          actionUrlExtend: "",
          fileSelected: false
        }
      }
  ...
  methods: {
    /** 导入按钮操作 */
    openDangerGoodsInventoryImportDialog(parentQueryParams) {

      if (dangerGoodsInventoryExtend.openImportDialogExtend(this, parentQueryParams)) {
    ...
    importTemplate() {
      ...
      this.download('autoee/dangerGoodsInventory/downLoadImportTemplateDangerGoodsInventory', {},
        `危化品库存_导入模版_${fileExt}.xlsx`)
    },
  ...
  mounted() {
    // mounted扩展方法
    dangerGoodsInventoryExtend.importMountedStartExtend(this);
  }
};
</script>
