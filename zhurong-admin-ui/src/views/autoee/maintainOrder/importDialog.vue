...
export default {
    ...
    return {
      pageData: {
        ...
        importData: {
          ...
          url: process.env.VUE_APP_BASE_API + "/autoee/maintainOrder/importMaintainOrderData",
          actionUrlExtend: "",
          fileSelected: false
        }
      }
  ...
  methods: {
    /** 导入按钮操作 */
    openMaintainOrderImportDialog(parentQueryParams) {

      if (maintainOrderExtend.openImportDialogExtend(this, parentQueryParams)) {
    ...
    importTemplate() {
      ...
      this.download('autoee/maintainOrder/downLoadImportTemplateMaintainOrder', {},
        `维修工单_导入模版_${fileExt}.xlsx`)
    },
  ...
  mounted() {
    // mounted扩展方法
    maintainOrderExtend.importMountedStartExtend(this);
  }
};
</script>
