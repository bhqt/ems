<template>
  <div class="app-container">
    ...
    >
      <!-- 循环生成查询表单项 -->
      <el-form-item class="a_query_form_item" :label="$t('goodsModule.stockInNo')" prop="id">
        <el-input
          clearable
          :placeholder="$t('goodsModule.stockInNo')"
      ...
      <el-form-item class="a_query_form_item" :label="$t('goodsModule.storageLocation')" prop="supplier">
        <el-input
          clearable
          :placeholder="$t('goodsModule.storageLocation')"
    ...
    >
      ...
      <el-table-column :label="$t('goodsModule.stockInNo')" align="center" prop="id" />
      ...
      <el-table-column v-if="true" :label="$t('goodsModule.stockInQty')" align="center" prop="quantity" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column v-if="true" :label="$t('goodsModule.storageLocation')" align="center" prop="supplier" sortable="custom" :sort-orders="['descending', 'ascending']"/>
