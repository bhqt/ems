...
export default {
    ...
    return {
      pageData: {
        ...
        importData: {
          ...
          url: process.env.VUE_APP_BASE_API + "/autoee/goodsInfo/importGoodsInfoData",
          actionUrlExtend: "",
          fileSelected: false
        }
      }
  ...
  methods: {
    /** 导入按钮操作 */
    openGoodsInfoImportDialog(parentQueryParams) {

      if (goodsInfoExtend.openImportDialogExtend(this, parentQueryParams)) {
    ...
    importTemplate() {
      ...
      this.download('autoee/goodsInfo/downLoadImportTemplateGoodsInfo', {},
        `物品信息管理_导入模版_${fileExt}.xlsx`)
    },
  ...
  mounted() {
    // mounted扩展方法
    goodsInfoExtend.importMountedStartExtend(this);
  }
};
</script>
