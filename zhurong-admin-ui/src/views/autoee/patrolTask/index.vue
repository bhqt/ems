<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="true" label="任务名称" align="center" prop="patrolTaskName" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      ...
      <el-table-column v-if="true" label="巡更日期" align="center" prop="patrolDate" sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
      ...
      <el-table-column v-if="true" label="任务状态" align="center" prop="patrolTaskStatus" sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
