...
export default {
    ...
    return {
      pageData: {
        ...
        importData: {
          ...
          url: process.env.VUE_APP_BASE_API + "/autoee/dangerGoodsInfo/importDangerGoodsInfoData",
          actionUrlExtend: "",
          fileSelected: false
        }
      }
  ...
  methods: {
    /** 导入按钮操作 */
    openDangerGoodsInfoImportDialog(parentQueryParams) {

      if (dangerGoodsInfoExtend.openImportDialogExtend(this, parentQueryParams)) {
    ...
    importTemplate() {
      ...
      this.download('autoee/dangerGoodsInfo/downLoadImportTemplateDangerGoodsInfo', {},
        `危化品信息管理_导入模版_${fileExt}.xlsx`)
    },
  ...
  mounted() {
    // mounted扩展方法
    dangerGoodsInfoExtend.importMountedStartExtend(this);
  }
};
</script>
