  ...
  <div class="app-container bg-container">
        ...
        <el-col :span="6">
          <div class="top-item-box item-box-one" style="display: flex;">
            <div style="flex:2;height:100%;">
              <div>{{ $t('dashboard.chargingUser') }}（{{ $t('dashboard.unitUser') }}）</div>
            ...
            <div style="flex:3;display: flex;flex-direction:column;justify-content:space-evenly">
              <div>{{ $t('dashboard.totalUser') }}：2344 {{ $t('dashboard.unitUser') }}</div>
              <div>{{ $t('dashboard.monthOverMonth') }}：13.46%</div>
              <div>{{ $t('dashboard.yearOverYear') }}：27.37%</div>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="top-item-box item-box-two" style="display: flex;">
            <div style="flex:2;height:100%;">
              <div>{{ $t('dashboard.chargingAmount') }}（{{ $t('dashboard.unitYuan') }}）</div>
              <div style="text-align:center;margin-top:30px;"><span style="font-size:26px;font-weight:bold;">4386.42</span></div>
            </div>
            <div style="flex:3;display: flex;flex-direction:column;justify-content:space-evenly">
              <div>{{ $t('dashboard.totalAmount') }}：764351.39 {{ $t('dashboard.unitYuan') }}</div>
              <div>{{ $t('dashboard.monthOverMonth') }}：32.0%</div>
              <div>{{ $t('dashboard.yearOverYear') }}：16.78%</div>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="top-item-box item-box-three" style="display: flex;">
            <div style="flex:2;height:100%;">
              <div>{{ $t('dashboard.chargingEnergy') }}（{{ $t('dashboard.unitKwh') }}）</div>
              <div style="text-align:center;margin-top:30px;"><span style="font-size:26px;font-weight:bold;">3671.58</span></div>
            </div>
            <div style="flex:3;display: flex;flex-direction:column;justify-content:space-evenly">
              <div>{{ $t('dashboard.totalEnergyKwh') }}：52412 {{ $t('dashboard.unitKwh') }}</div>
              <div>{{ $t('dashboard.monthOverMonth') }}：41.27%</div>
              <div>{{ $t('dashboard.yearOverYear') }}：36.82%</div>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="top-item-box item-box-four" style="display: flex;">
            <div style="flex:2;height:100%;">
              <div>{{ $t('dashboard.chargingCount') }}（{{ $t('dashboard.unitCount') }}）</div>
              <div style="text-align:center;margin-top:30px;"><span style="font-size:26px;font-weight:bold;">167</span></div>
            </div>
            <div style="flex:3;display: flex;flex-direction:column;justify-content:space-evenly">
              <div>{{ $t('dashboard.totalCount') }}：2412 {{ $t('dashboard.unitCount') }}</div>
              <div>{{ $t('dashboard.monthOverMonth') }}：23.4%</div>
              <div>{{ $t('dashboard.yearOverYear') }}：21.67%</div>
            </div>
          </div>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="12">
        <el-col :span="6">
          <el-card class="box-card" shadow="never">
            <div class="card-title">{{ $t('dashboard.chargingTerminalStatus') }}</div>
        ...
        <el-col :span="18">
          <el-card class="box-card" shadow="never">
            <div style="display:flex;justify-content: space-between;align-items: center;">
              <div class="card-title">{{ $t('dashboard.chargingOrderTrend') }}</div>
    ...
    <div class="station-bottom">
      <el-row :gutter="12">
        <el-col :span="6">
          <el-card class="box-card" shadow="never">
            <div class="card-title">{{ $t('dashboard.last7DaysCount') }}</div>
            <div style="height: calc(100% - 30px);">
        ...
        <el-col :span="6">
          <el-card class="box-card" shadow="never">
            <div class="card-title">{{ $t('dashboard.last7DaysDuration') }}</div>
            <div style="height: calc(100% - 30px);">
              <StationLineVue height="100%" yName="h" :seriesName="$t('dashboard.duration')" :chartData="lineDataTwo" itemColor="#5470c6"/>
            </div>
          </el-card>
        </el-col>
        <el-col :span="6">
          <el-card class="box-card" shadow="never">
            <div class="card-title">{{ $t('dashboard.last7DaysEnergy') }}</div>
            <div style="height: calc(100% - 30px);">
              <StationLineVue height="100%" yName="kW·h" :seriesName="$t('dashboard.energy')" :chartData="lineDataThree" itemColor="#c58bea"/>
            </div>
          </el-card>
        </el-col>
        <el-col :span="6">
