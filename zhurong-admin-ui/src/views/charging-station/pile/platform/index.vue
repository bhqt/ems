<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item :label="$t('chargingModule.pile.pileCode')" prop="encoding">
        <el-input
          v-model="queryParams.encoding"
          :placeholder="$t('placeholder.input') + $t('chargingModule.pile.pileCode')"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item :label="$t('chargingModule.pile.pileName')" prop="name">
        <el-input
          v-model="queryParams.name"
          :placeholder="$t('placeholder.input') + $t('chargingModule.pile.pileName')"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item :label="$t('chargingModule.station.merchantName')" prop="merchantName" >
        <el-input
          ...
          :placeholder="$t('placeholder.input') + $t('chargingModule.station.merchantName')"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="pileList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :label="$t('chargingModule.pile.pileCode')" align="center" prop="encoding" />
      <el-table-column :label="$t('chargingModule.pile.pileName')" align="center" prop="name" />
      ...
      <el-table-column :label="$t('chargingModule.pile.pileModel')" align="center" prop="model" />
