  ...
  <div class="app-container">
    ...
    <el-card class="search-card" shadow="hover">
      <el-form :inline="true" :model="searchForm" class="mb-4">
        ...
        <el-form-item label="终端编码">
          <el-input v-model="searchForm.encoding" :placeholder="$t('common.pleaseInput')" clearable style="width: 200px;"></el-input>
        </el-form-item>
        <el-form-item label="品牌">
          <el-input v-model="searchForm.brand" :placeholder="$t('common.pleaseInput')" clearable style="width: 200px;"></el-input>
        </el-form-item>
        <el-form-item label="型号">
          <el-input v-model="searchForm.model" :placeholder="$t('common.pleaseInput')" clearable style="width: 200px;"></el-input>
        </el-form-item>
    ...
    <el-card class="table-card" shadow="hover">
      <el-table :data="gridData" style="width: 100%" stripe>
        ...
        <el-table-column prop="statusName" :label="$t('common.status')" width="100"></el-table-column>
        <el-table-column prop="workStatus" label="工作状态" width="100"></el-table-column>
        <el-table-column prop="remark" :label="$t('common.remark')" show-overflow-tooltip></el-table-column>
        <el-table-column :label="$t('common.operation')" width="240" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button type="danger" size="small" @click="handleDelete(scope.row.pileId)">{{ $t('common.delete') }}</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="600px">
      <el-form :model="form" :rules="rules" ref="formRef" label-width="120px">
        ...
        <el-form-item label="终端编码" prop="encoding">
          <el-input v-model="form.encoding" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="终端类型" prop="type">
          <el-input v-model="form.type" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="归属商户" prop="merchantId">
          <el-input v-model="form.merchantId" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="归属商户名" prop="merchantName">
          <el-input v-model="form.merchantName" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="归属电站" prop="stationId">
          <el-input v-model="form.stationId" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="归属电站名称" prop="stationName">
          <el-input v-model="form.stationName" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="品牌" prop="brand">
          <el-input v-model="form.brand" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="型号" prop="model">
          <el-input v-model="form.model" :placeholder="$t('common.pleaseInput')" style="width: 400px;"></el-input>
        </el-form-item>
