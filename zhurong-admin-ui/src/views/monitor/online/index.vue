<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="68px">
      ...
      <el-form-item :label="$t('table.loginName')" prop="userName">
        <el-input
          v-model="queryParams.userName"
          :placeholder="$t('table.loginName')"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    >
      ...
      <el-table-column :label="$t('monitor.online.sessionId')" align="center" prop="tokenId" :show-overflow-tooltip="true" />
      ...
      <el-table-column :label="$t('monitor.online.browser')" align="center" prop="browser" />
...
export default {
  ...
  methods: {
    ...
    handleForceLogout(row) {
      this.$modal.confirm(this.$t('monitor.online.forceLogoutConfirm').replace('{username}', row.userName)).then(function() {
