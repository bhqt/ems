<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item :label="$t('form.dictName')" prop="dictName">
        <el-input
          v-model="queryParams.dictName"
          :placeholder="$t('placeholder.dictName')"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item :label="$t('form.dictType')" prop="dictType">
        <el-input
          v-model="queryParams.dictType"
          :placeholder="$t('placeholder.dictType')"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :label="$t('table.dictId')" align="center" prop="dictId" />
      <el-table-column :label="$t('table.dictName')" align="center" prop="dictName" :show-overflow-tooltip="true" />
      <el-table-column :label="$t('table.dictType')" align="center" :show-overflow-tooltip="true">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item :label="$t('form.dictName')" prop="dictName">
          <el-input v-model="form.dictName" :placeholder="$t('placeholder.dictName')" />
        </el-form-item>
        <el-form-item :label="$t('form.dictType')" prop="dictType">
          <el-input v-model="form.dictType" :placeholder="$t('placeholder.dictType')" />
        </el-form-item>
        <el-form-item :label="$t('table.status')" prop="status">
