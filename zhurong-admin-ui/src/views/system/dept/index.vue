<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      <el-form-item :label="$t('form.deptName')" prop="deptName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        ...
        >{{ $t('system.dept.expandAll') }}</el-button>
      </el-col>
    ...
    >
      <el-table-column prop="deptName" :label="$t('form.deptName')" width="260"></el-table-column>
      <el-table-column prop="orderNum" :label="$t('form.showOrder')" width="200"></el-table-column>
      <el-table-column prop="status" :label="$t('table.status')" width="100">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_normal_disable" :value="scope.row.status"/>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.createTime')" align="center" prop="createTime" width="200">
        <template slot-scope="scope">
