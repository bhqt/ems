<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      <el-form-item :label="$t('form.menuName')" prop="menuName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        ...
        >{{ $t('system.menu.expandAll') }}</el-button>
      </el-col>
    ...
    >
      <el-table-column prop="menuName" :label="$t('table.menuName')" :show-overflow-tooltip="true" width="160"></el-table-column>
      <el-table-column prop="icon" :label="$t('table.icon')" align="center" width="100">
        <template slot-scope="scope">
          <svg-icon :icon-class="scope.row.icon" />
        </template>
      </el-table-column>
      <el-table-column prop="orderNum" :label="$t('form.menuSort')" width="60"></el-table-column>
      <el-table-column prop="perms" :label="$t('table.perms')" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="component" :label="$t('table.component')" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="status" :label="$t('table.status')" width="80">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_normal_disable" :value="scope.row.status"/>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.createTime')" align="center" prop="createTime">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="680px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24" v-if="form.menuType != 'F'">
            <el-form-item :label="$t('system.menu.menuIcon')" prop="icon">
              ...
              >
                ...
                <el-input slot="reference" v-model="form.icon" :placeholder="$t('system.menu.selectIcon')" readonly>
                  <svg-icon
                    v-if="form.icon"
                    slot="prefix"
          ...
          <el-col :span="12">
            <el-form-item :label="$t('form.menuSort')" prop="orderNum">
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item prop="path">
              ...
              <el-input v-model="form.path" :placeholder="$t('placeholder.pathRequired')" />
            </el-form-item>
          </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        menuName: [
          { required: true, message: this.$t('rules.menuNameRequired'), trigger: "blur" }
        ],
        orderNum: [
          { required: true, message: this.$t('rules.pathRequired'), trigger: "blur" }
        ],
        path: [
          { required: true, message: this.$t('rules.pathRequired'), trigger: "blur" }
        ]
  ...
  methods: {
    ...
    getTreeselect() {
      listMenu().then(response => {
        this.menuOptions = [];
        const menu = { menuId: 0, menuName: this.$t('system.menu.parentMenu'), children: [] };
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm(this.$t('confirm.delete') + ' "' + row.menuName + '"?').then(function() {
