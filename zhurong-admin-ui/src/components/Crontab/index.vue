<template>
  <div>
    ...
    <div class="popup-main">
      ...
      <div class="pop_btn">
        <el-button size="small" type="primary" @click="submitFill">{{ $t('button.submit') }}</el-button>
        <el-button size="small" type="warning" @click="clearCron">{{ $t('button.reset') }}</el-button>
        <el-button size="small" @click="hidePopup">{{ $t('button.cancel') }}</el-button>
      </div>
    </div>
  </div>
</template>
